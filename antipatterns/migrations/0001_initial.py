# Generated by Django 5.2 on 2025-05-13 08:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, help_text='Как заметить Анти-паттерн?', max_length=200, verbose_name='Как заметить?')),
